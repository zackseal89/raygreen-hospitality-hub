...
const Booking = () => {
  ...
  const [bookingStep, setBookingStep] = useState<'dates' | 'rooms' | 'details'>('dates');
              ...
              <div key={step} className="flex items-center">
                <div className={cn(
                  ...
                  bookingStep === step 
                    ...
                    : index < ['dates', 'rooms', 'details'].indexOf(bookingStep)
                    ? "bg-hotel-green text-white border-hotel-green"
                ...
                {index < 2 && <div className="w-8 h-px bg-muted-foreground mx-4" />}
              </div>
            ))}
          </div>
        </div>
